...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,rel_pos=False,
        ...
        if self.shift_size > 0:
            ...
            # print(rf"new input_resolution: {Hp} {Wp}")
        ...
        self.attn__qkv = nn.Linear(dim, dim * 3, bias=qkv_bias)
        ...
        self.cls_atten = ClsAttention(
            ...
            qk_scale=qk_scale, attn_drop=attn_drop)
        self.attn__proj = nn.Linear(dim, dim)
    ...
    def forward(self, x):
        ...
        #1: obtain qkv
        x = self.norm1(x)
        qkv = self.attn__qkv(x)  #B*L*3C,  L = N+1
