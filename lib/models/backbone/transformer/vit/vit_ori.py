...
from ..utils.helpers import to_2tuple, trunc_normal_
from ..utils.load_pretrained import load_pretrained_vit
...
class HybridEmbed(nn.Module):
    ...
    def __init__(self, backbone, img_size=224, feature_size=None, in_chans=3, embed_dim=768):
        ...
        img_size = to_2tuple(img_size, img_size)
        self.img_size = img_size
...
class Transformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=True, qk_scale=None, representation_size=None,
                 class_flag=False, feat_embded=False,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0., hybrid_backbone=None, norm_layer=None):
        """
        Args:
            img_size (int, tuple): input image size
...
def ViT(variant, num_classes=5, img_size=224,  patch_size=16, pretrained=False, pre_model_path=None,in_chans=3, **kwargs):
    model = VisionTransformer(img_size = img_size, num_classes=num_classes,
        patch_size=patch_size, embed_dim=768, depth=8, num_heads=8, mlp_ratio=3, qkv_bias=False,
